...
<div class="px-4 pt-5 mt-3 text-center border-bottom">
  ...
  <div class="col-lg-6 mx-auto">
    ...
    <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
      <button type="button" class="btn btn-warning btn-lg px-4 me-sm-3">My Garden</button>
      <button type="button" class="btn btn-outline-dark btn-lg px-4">Learn About Gardens</button>
    </div>
  </div>
