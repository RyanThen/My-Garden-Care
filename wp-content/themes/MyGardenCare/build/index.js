...
class Events {
  ...
  async getEventResults() {
    try {
      ...
      const res = await axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(`https://app.ticketmaster.com/discovery/v2/events.json?subGenreId=KZazBEonSMnZfZ7vAvF&apikey=${_api_js__WEBPACK_IMPORTED_MODULE_0__.apiKey}`);
...
/* harmony export */ });
const apiKey = 'sRNlmkItIqnllpCqxpaf1zzgzOZ5gIr3';
...
const events = new _modules_Events_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
})();
